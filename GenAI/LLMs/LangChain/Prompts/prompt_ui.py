...
# :: Exporting the PromptTemplate from outer source json file : 
...
# # :: loading the template from outer source template.json : 

# template = load_prompt(r'C:\Users\ANUBHAV\Program_Folders\AI\GenAI\LLMs\LangChain\Prompts\template.json')
...
# :: Using the Chains functionality from the PromptTemplate Class: 
